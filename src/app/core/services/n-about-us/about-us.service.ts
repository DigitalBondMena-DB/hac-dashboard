...
export class AboutUsService {
  ...
  getAboutUs() {
    return this.http.get<IAboutUsData>(`${WEB_SITE_BASE_URL}aboutindex`);
  }
  updateAboutUs(aboutUsData: FormData) {
    return this.http.post<IAboutUsUpdateResponse>(`${WEB_SITE_BASE_URL}aboutupdate/1`, aboutUsData);
  }
}
