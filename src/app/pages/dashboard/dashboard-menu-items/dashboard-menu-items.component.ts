...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterLink, RouterLinkActive, SidebarModule, DashboardMenuItemsComponent, BadgeModule],
...
export class DashboardMenuItemsComponent {
  ...
  updateActiveStateFromRoute() {
    ...
    let activeRoute = this.router.isActive(targetTree, options);
  ...
  isActive = (router: Router): boolean => {
    ...
    return (currentUrl.startsWith(routeLink) && currentUrl !== "/dashboard") as boolean; // exclude empty/initial routes
  };
}
