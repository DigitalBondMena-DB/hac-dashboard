...
@Component({
  ...
  standalone: true,
  imports: [ButtonModule, CardModule, InputSwitchModule, DialogModule, FormsModule, ReactiveFormsModule],
...
export class LNotificationsComponent {
  ...
  sendNotification() {
    ...
    this.notificationsService.sendNotifications(notificationData);
    this.messageService.add({ severity: "success", summary: "Sent", detail: "Notification Sent successfully" });
    timer(500).subscribe(() => this.ngxSpinnerService.hide("actionsLoader"));
